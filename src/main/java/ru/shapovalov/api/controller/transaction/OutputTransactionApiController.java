...
public class OutputTransactionApiController {
    private final TransactionRepository transactionRepository;
    private final AccountRepository accountRepository;

    @PostMapping("/user/output")
    public ResponseEntity<List<Transaction>> getUserOutputTransactions(HttpServletRequest request) {
        ...
        List<Transaction> userTransactions = transactionRepository.findByFromAccountIdIn(accountIds);
