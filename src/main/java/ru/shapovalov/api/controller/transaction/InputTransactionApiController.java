...
public class InputTransactionApiController {
    private final TransactionRepository transactionRepository;
    private final AccountRepository accountRepository;

    @PostMapping("/user/input")
    public ResponseEntity<List<Transaction>> getUserInputTransactions(HttpServletRequest request) {
        ...
        List<Transaction> userTransactions = transactionRepository.findByToAccountIdIn(accountIds);
