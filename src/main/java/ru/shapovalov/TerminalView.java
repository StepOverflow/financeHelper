                        ...
                        while (exit2) {
                            ...
                            switch (choice2) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    long id = requestLong("Enter category id for delete: ");
                                    ...
                                    break;
                                case 6:
                                    id = requestLong("Enter category id for edit:");
                                ...
                                case 8:
                                    ...
                                    break;
                                case 9:
                                    long sender = requestLong("Specify from which account id funds will be debited");
                                    long recipient = requestLong("Specify which account the funds will be transferred to. " +
                                            "if this is an unknown account, enter 0");
                                    int sum = requestInt("Enter the desired amount");
                                    List<Long> categoryIds = new ArrayList<>();
                                    long categoryId;
                                    do {
                                        categoryId = requestLong("Enter category ID (enter 0 to finish):");
                                        if (categoryId != 0) {
